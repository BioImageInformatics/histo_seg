...
def make_testable(train_model_path):
    ...
    if train_net.layer[1].name == "data" and train_net.layer[1].include:
        print "Removing test data layer"
...
def run(out_dir, train_model, weights, out_name):
    ...
    print "Getting info about the training set contents"
    ...
    ## To set manually; i.e. to use a subset of the training set
    ## Stats are calculated using the baked in minibatch_size in the proto anyway
    # train_size = 10000
    # minibatch_size = 8
