...
## Stuff for the loading and saving
    'output_dir':       '/home/nathan/histo-seg/semantic-pca/analysis_wsi/segnet_basic_wholeset',
    'ramdisk':          '/dev/shm',
...
filename = 'example/segnet_basic_whole_settings.pkl'
